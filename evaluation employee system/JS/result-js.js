    ...
    if (obj.status == "poor") {
      ...
      if (obj.question == "time") {
        document.getElementById(
          `cr7`
        ).innerHTML += `<b>Time :</b>  Time management is nothing more than a process for effectively managing time for 
          your work. It doesn’t require much effort, but good planning is essential..<br><br>`;
      }
      if (obj.question == "dressing") {
        document.getElementById(
          `cr7`
        ).innerHTML += `<b> Dressing :</b>  Dressing plays an essential role in public speaking. It is the way you dress which speaks volumes about your personality and confidence. A public speaker needs to dress as per the occasion, time and season. If you are addressing your office colleagues during the office hours,
          it is essential to stick to formal dressing. <br><br>`;
      }
      if (obj.question == "speech") {
        document.getElementById(
          `cr7`
        ).innerHTML += `<b> Speech :</b> Practice Beforehand. Practice replacing filler words like "um," "so," and "like" with silence. ...
          Work the Room. ...
      ...
      if (obj.question == "done") {
        document.getElementById(
          `cr7`
        ).innerHTML += `<b>done :</b>  never  take  advice  on an area  of life form someone  who  is  not doing  better  in it  than  you are . choose your mentors and  teachers wisely .
          learn  from those  who already are  or have  what you want to become or have . learn "up"<br><br>`;
      }
      if (obj.question == "accomplish") {
        document.getElementById(
          `cr7`
        ).innerHTML += `<b>Accomplish :</b>Find the balance that works for today. Work and life are both demanding. ...
      ...
      if (obj.question == "work") {
        document.getElementById(
          `cr7`
        ).innerHTML += `<b>Work :</b> Never Stop Learning. One of the most powerful things to advance your career -- or in any circumstance for that matter -- is knowledge. ...
          Work On Goals. ...
          Be Organized. ...
          Be A Team Player. ...
          Value Your Network. ...
      ...
      if (obj.question == "learning") {
        document.getElementById(
          `cr7`
        ).innerHTML += `<b>Learning :</b>  Pick a place and time. Everyone has their own idea about the best place and time to study. ...
          Study every day. ...
          Plan your time. ...
      ...
      if (obj.question == "asked") {
        document.getElementById(
          `cr7`
        ).innerHTML += `<b>Ask for help :</b> Earn responses to your requests by generously helping others in the first place. ...
      ...
      if (obj.question == "Creativity") {
        document.getElementById(
          `cr7`
        ).innerHTML += `<b>Creativity :</b>  Practice. It may sound obvious, but practice is essential for creativity. ...
